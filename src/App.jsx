...
function App() {
  ...
  const addInformation = async (name, amount, comment) => {
    ...
    <main>
      <div className="max-w-3xl mx-auto p-4">
        ...
        <Modal
          ...
          contentLabel={isUpdate ? "Edit Information" : "Add Information"}
          className="max-w-md w-full p-6 rounded-lg shadow-lg bg-white relative border border-gray-300"
          ariaHideApp={false}
          overlayClassName="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50"
        >
          <h2 className="text-2xl font-bold mb-4 text-center">{isUpdate ? "Edit Information" : "Add Information"}</h2>
          <input
            type="text"
            name="name"
            placeholder="Name"
          ...
          <div className="flex justify-between mt-4">
            ...
            <button
              onClick={() => { isUpdate ? updateInformation(updateId, name, amount, comment) : addInformation(name, amount, comment) }}
